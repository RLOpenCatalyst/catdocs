...
*. Fill all the required details:
  ...
  Once both the links will be configured, both will be visible in **List of Dashboards**

    .. image:: /images/AT3.png

  Perform some actions on the instance which will be recorded in the logs.
  Navigate to Track -> Audit Trail, here, you will get the logs which you created for instance and task.
  Click on Instance Log it will show all the details about that instance performed actions, time, OS, providers, status etc.

    .. image:: /images/AT4.png

  And to check about the orchestration task click on orchestrationLogs it will show all the details about that perticular task start time, end time, job type, name status etc.

    .. image:: /images/AT5.png 
